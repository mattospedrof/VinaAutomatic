...
def main():
    print('O seu docking já vai começar, aguarde!!')
    print('Obrigado pelo apoio!!')

    config_file = 'config.txt'

    if not os.path.isfile(config_file):
        print('Arquivo de configuração não encontrado. Certifique-se de que o arquivo config.txt está presente.')
        exit()
    ...
    data = process_results(input_directory)
